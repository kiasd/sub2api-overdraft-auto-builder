<template>
  <header class="anime-console-header glass sticky top-0 z-30 border-b border-gray-200/50 dark:border-dark-700/50">
    <div class="anime-console-header-row flex h-16 items-center justify-between gap-2 px-2 sm:px-4 md:px-6">
      ...
      <div class="anime-header-tools flex min-w-0 items-center gap-1 sm:gap-3">
        <!-- Announcement Bell -->
        ...
        <a
          ...
          class="anime-header-tool hidden items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-sm font-medium text-gray-600 transition-colors hover:bg-gray-100 hover:text-gray-900 dark:text-dark-400 dark:hover:bg-dark-800 dark:hover:text-white sm:flex"
        >
        ...
        <router-link
          ...
          class="anime-header-tool flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-sm font-medium text-gray-600 transition-colors hover:bg-gray-100 hover:text-gray-900 dark:text-dark-400 dark:hover:bg-dark-800 dark:hover:text-white"
        >
        ...
        <div
          v-if="user"
          class="anime-balance-chip group relative hidden items-center gap-2 rounded-xl bg-primary-50 px-3 py-1.5 dark:bg-primary-900/20 sm:flex"
        >
          <svg
        ...
        <div v-if="user" class="relative" ref="dropdownRef">
          <button
            ...
            class="anime-user-chip flex items-center gap-2 rounded-xl p-1.5 transition-colors hover:bg-gray-100 dark:hover:bg-dark-800"
