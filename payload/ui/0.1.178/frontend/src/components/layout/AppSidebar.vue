  ...
  >
    ...
    <div class="sidebar-header" :class="{ 'sidebar-header-collapsed': sidebarCollapsed }">
      ...
      <div class="sidebar-brand" :class="{ 'sidebar-brand-collapsed': sidebarCollapsed }" :aria-hidden="sidebarCollapsed ? 'true' : 'false'">
        ...
        <!-- Version Badge -->
        <OfficialVersionBadge :version="siteVersion" />
      </div>
    </div>
    ...
    <div v-if="!sidebarCollapsed" class="anime-sidebar-operator" aria-hidden="true">
      <img :src="supportMascot" alt="" />
      <div>
        <span><i></i> SYSTEM ONLINE</span>
        <strong>小助手值守中</strong>
        <small>请求通道运行正常</small>
      </div>
    </div>
...
import OfficialVersionBadge from '@/components/common/OfficialVersionBadge.vue'
